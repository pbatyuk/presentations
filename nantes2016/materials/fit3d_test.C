void fit3d_test() {
 ...
 TCanvas *c0 = new TCanvas("c0", "c0", 1500, 600);
 c0->Divide(3,1);
 ...
 for(int ipt=0; ipt<NPT; ipt++)   //  pt loop
  ...
  gStyle->SetOptStat(0);
   for(int k=0; k<NPT; k++)   //  pt loop
	...
	//////////////////////////////////////////////////////////////////////
	ratioy->SetTitle("C(q_{side})");
	ratioy->SetTitleSize(5);
	ratioy->GetXaxis()->SetTitle("q_{side}, GeV/c");
        ratioy->GetYaxis()->SetLabelSize(0.075);
        ratioy->GetXaxis()->SetLabelSize(0.075);
        ratioy->GetYaxis()->SetTitleSize(0.075);
        ratioy->GetXaxis()->SetTitleSize(0.075);
	ratioy->GetXaxis()->SetTitleOffset(0.55);
	ratioy->GetYaxis()->SetTitleOffset(-0.55);
	ratioy->GetXaxis()->SetLabelOffset(-0.02);
	// ratiox->GetYaxis()->SetTickLength(0.05);
	...
	//////////////////////////////////////////////////////////////////////
	ratioz->SetTitle("C(q_{long})");
	//	ratioz->SetTitleSize(5);
	ratioz->GetXaxis()->SetTitle("q_{long}, GeV/c");
        ratioz->GetYaxis()->SetLabelSize(0.075);
        ratioz->GetXaxis()->SetLabelSize(0.075);
        ratioz->GetYaxis()->SetTitleSize(0.075);
        ratioz->GetXaxis()->SetTitleSize(0.075);
	ratioz->GetXaxis()->SetTitleOffset(0.55);
	ratioz->GetYaxis()->SetTitleOffset(-0.55);
	ratioz->GetXaxis()->SetLabelOffset(-0.02);
	// ratiox->GetYaxis()->SetTickLength(0.05);
